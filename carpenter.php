...
<head>
    ...
    <title>Carpentry Service Provider Dashboard</title>
...
<body>
    ...
    <a href="index.php" class="logo"></a> <!-- Add anchor tag here -->
        <div class="button-container">
            ...
            <a href="./contact4.html" class="button">Contact Now</a>
    ...
    <div class="container">
        ...
        if (isset($_SESSION['name'])) {
            ...
            echo "<p style='text-align: center'>This is your dashboard where you can manage carpentery service-related tasks and also you can manage prices related to those services.</p>";
        } else {
        ...
        <div class="button-container-inner">
            <a href="carpenter_manage_orders.php" class="button">Manage Orders</a>
            <a href="feedback.html" class="button">Feedback Form</a>
            <a href="carpenter_manage_prices_services.php" class="button">Manage Prices and Services</a>
        </div>
