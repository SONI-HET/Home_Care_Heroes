...
$query = "SELECT * FROM plumbing_request WHERE username = '$username'";
...
if (isset($_POST['tick'])) {
    ...
    $price_query = "SELECT price FROM plumbing_services_prices WHERE service_id = (SELECT id FROM plumbing_services WHERE service_name = '$service')";
    $price_result = mysqli_query($conn, $price_query);
    $row = mysqli_fetch_assoc($price_result);
    $price = $row['price'];

    // Update the database
    $update_query = "UPDATE plumbing_request SET service='$service', price='$price', appointment_date='$pickup_date', appointment_time='$pickup_time' WHERE order_id='$order_id' AND username='$username'";
...
if (isset($_POST['delete'])) {
    ...
    $delete_query = "DELETE FROM plumbing_request WHERE order_id='$order_id'";
...
<body>
                ...
                <tr>
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <td>
                            ...
                            else echo "<input type='date' name='pickup_date' value='" . (isset($_POST['appointment_date']) ? $_POST['appointment_date'] : $row['appointment_date']) . "' />"; ?>
                        </td>
                        <td>
                            <?php if (!isset($_POST['edit']) || $_POST['order_id'] != $row['order_id']) echo $row['appointment_time'];
                            else echo "<input type='time' name='pickup_time' value='" . (isset($_POST['appointment_time']) ? $_POST['appointment_time'] : $row['appointment_time']) . "' />"; ?>
                        </td>
                        ...
                        <td>
                            <?php if (!isset($_POST['edit']) || $_POST['order_id'] != $row['order_id']) echo $row['service'];
                                ...
                                $plumbing_services_query = "SELECT * FROM plumbing_services";
    ...
    <?php else : ?>
        <p>No plumbing requests found.</p>
    <?php endif; ?>
