...
function loadServices($conn, $provider_name) {
    $output = "";
    $sql = "SELECT cs.id, cs.service_name, sp.price FROM carpentry_services cs LEFT JOIN service_prices sp ON cs.id = sp.service_id WHERE cs.provider_name = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['add-service'])) {
        ...
        $sql_insert_service = "INSERT INTO carpentry_services (service_name, provider_name) VALUES (?, ?)";
        ...
        $sql_insert_price = "INSERT INTO service_prices (service_id, price) VALUES (?, ?)";
    ...
    if (isset($_POST['edit-service'])) {
        ...
        $sql_update_service = "UPDATE carpentry_services SET service_name = ? WHERE id = ?";
        ...
        $sql_update_price = "UPDATE service_prices SET price = ? WHERE service_id = ?";
...
if (isset($_POST['delete-service'])) {
    ...
    $sql_delete_prices = "DELETE FROM service_prices WHERE service_id = ?";
    ...
    if (mysqli_stmt_execute($stmt_delete_prices)) {
        ...
        $sql_delete_service = "DELETE FROM carpentry_services WHERE id = ?";
