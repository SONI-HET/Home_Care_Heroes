...
<body>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM carpentry_request WHERE service_provider_name = '$loggedInServiceProvider'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td class='status-" . strtolower($row["request_status"]) . "'>";
                            echo $row["request_status"] . " <i class='fas fa-pencil-alt edit-icon' onclick='editStatus(\"" . $row["order_id"] . "\")'></i>";
                            echo "</td>";
    ...
    <script>
        function editStatus(orderId) {
            ...
            var newStatus = prompt("Enter new status (Pending, Approved, Rejected):");
        ...
        function updateStatus(newStatus, orderId) {
            ...
            xhr.open("POST", "update_carpentry_status.php", true);
            xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            xhr.send("request_status=" + newStatus + "&order_id=" + orderId);
        }
    </script>
